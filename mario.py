...
class Mario(pg.sprite.Sprite):
    def __init__(self, blocks, q_blocks, coins, pipes, goombas, koopas, items, collide_objs):
...
>>>>>>> joseph-branch
    ...
    def check_mario_x_collisions(self):
        ...
        goomba = pg.sprite.spritecollideany(self, self.goombas)
